              ...
              <div className="mt-3 flex items-center justify-between">
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="inline-flex cursor-pointer items-center gap-1 rounded-lg px-2 py-1.5 text-[10px] font-medium text-emerald transition-colors hover:bg-emerald-dim"
                  ...
                  <button
                    ...
                    className="inline-flex cursor-pointer items-center gap-1 rounded-lg px-2 py-1.5 text-[10px] font-medium text-rose transition-colors hover:bg-rose-dim"
                  ...
                  <button
                    ...
                    className="inline-flex cursor-pointer items-center gap-1 rounded-lg px-2 py-1.5 text-[10px] font-medium text-text-secondary transition-colors hover:bg-surface-raised hover:text-text-primary"
                  >
