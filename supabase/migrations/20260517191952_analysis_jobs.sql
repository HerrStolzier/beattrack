-- Persistent status for uploaded audio analysis jobs.
--
-- Recovered from the codex/beattrack-improvement-plan branch, where it was
-- numbered 023 and never merged. The table exists in the live database
...
-- authoring time, so it sorts before 20260607150242, which grants on this
-- table and would fail without it.
